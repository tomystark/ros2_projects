...
private:
    ...
    // Callback to recieve feedback while executing the goal
    void goal_feedback_callback(const CountUntilGoalHandle::ConstSharedPtr &goal_handle,
        const std::shared_ptr<const CountUntilGoalHandle::Feedback> feedback)
    {
        (void)goal_handle;
